...
// Message actions
router.put('/messages/:messageId', authenticate, validate(editMessageSchema), messageController.editMessage);
router.delete('/messages/:messageId', authenticate, validate(deleteMessageSchema), messageController.deleteMessage);
router.post('/messages/:messageId/recall', authenticate, validate(recallMessageSchema), messageController.recallMessage);
...
router.post('/messages/:messageId/react', authenticate, validate(reactMessageSchema), messageController.reactToMessage);
